...
// and MainActivity does not call it — it registers the location plugin there and
// nothing else. Setting the attribute without that call can leave the app
// sitting on the launch theme.
